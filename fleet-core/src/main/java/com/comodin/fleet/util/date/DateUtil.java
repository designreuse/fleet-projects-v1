...
public class DateUtil {
     ...
     * @return the date
     */
    public static Date timeStampToDate(String seconds, String pattern) {
        String format = timeStamp2Date(seconds, pattern);
        return DateUtil.StringToDate(format);
    }
     ...
     * @return the string
     */
    public static String date2TimeStamp(String date_str, String pattern) {
        try {
            //TimeZone.setDefault(TimeZone.getTimeZone("GMT-6:00"));
            SimpleDateFormat sdf = new SimpleDateFormat(pattern);

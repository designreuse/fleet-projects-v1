                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="modal_Create_Form_Element_name"><span style="color:red">*</span>Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="name" placeholder="Name" id="modal_Create_Form_Element_name">
                                        </div>
                                    </div>

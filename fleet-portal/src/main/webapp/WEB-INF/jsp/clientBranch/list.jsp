...
<html lang="en">
<head>
    <title>Client Outlets List</title>
    <meta charset="UTF-8">
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Client Branch List</h1>
            </div>
        </div>
        <%--右侧区域：头部标题--%>
...
<script type="text/javascript" charset="UTF-8" src="<%=staticResourcesPath%>/resources/js/item/clientBranch/ClientBranchManage.js"></script>
</body>
</html>

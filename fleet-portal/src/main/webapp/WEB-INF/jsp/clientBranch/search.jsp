    ...
    <div class="col-md-12">
        <form class="form-horizontal" id="modal_Search_Form">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-2">
                    <input id="modal_Search_Form_Element_phone" name="phone" placeholder="Phone" type="text" class="form-control" onkeydown="if(event.keyCode==13){$('#btn_Search').click();return false;}">
                </div>
                <label class="col-sm-4 control-label" for="modal_Search_Form_Element_address">Address</label>
                <div class="col-sm-5">
                    <input id="modal_Search_Form_Element_address" name="address" placeholder="Address" type="text" class="form-control" onkeydown="if(event.keyCode==13){$('#btn_Search').click();return false;}">
                </div>

    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Keychain</h4>
            </div>
            <%--模态框 页头header end--%>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="modal_Update_Form_Element_name"><span style="color:red">*</span>Keychain Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="name" placeholder="Keychain Name" id="modal_Update_Form_Element_name">
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Keychain List</h1>
            </div>
        </div>
        <%--右侧区域：头部标题--%>
...
<script type="text/javascript" charset="UTF-8" src="<%=staticResourcesPath%>/resources/js/item/keychain/KeychainManage.js"></script>
</body>
</html>

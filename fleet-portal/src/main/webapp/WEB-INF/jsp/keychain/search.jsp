...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal" id="modal_Search_Form">
            ...
            <input type="reset" id="modal_Search_Form_Button_Reset"
                   style="display: none;"/>

            <div class="form-group has-feedback">
                <label class="col-sm-1 control-label"
                       for="modal_Search_Form_Element_name">Name</label>
                <div class="col-sm-2">
                    <input id="modal_Search_Form_Element_name" name="name" placeholder="Keychain Name" type="text" class="form-control"
                           onkeydown="if(event.keyCode==13){$('#btn_Search').click();return false;}">
                </div>
                <label class="col-sm-1 control-label"
                       for="modal_Search_Form_Element_assignDriverName">Driver Name</label>
                <div class="col-sm-2">
                    <input id="modal_Search_Form_Element_assignDriverName" name="assignDriverName" placeholder="Assign Driver Name" type="text" class="form-control"
                           onkeydown="if(event.keyCode==13){$('#btn_Search').click();return false;}">
                </div>

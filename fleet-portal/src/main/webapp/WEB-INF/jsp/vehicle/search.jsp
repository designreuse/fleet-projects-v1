    ...
    <div class="col-md-12">
        <form class="form-horizontal" id="modal_Search_Form">
            ...
            <div class="form-group has-feedback">
                ...
                <label class="col-sm-1 control-label" for="modal_Search_Form_Element_licensePlate">LicensePlate</label>
                <div class="col-sm-2">
                    <input id="modal_Search_Form_Element_licensePlate" name="licensePlate" placeholder="LicensePlate" type="text" class="form-control"
                           onkeydown="if(event.keyCode==13){$('#btn_Search').click();return false;}">
                </div>

                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="modal_Update_Form_Element_name"><span style="color:red">*</span>Vehicle Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="name" placeholder="Vehicle Name" id="modal_Update_Form_Element_name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="modal_Update_Form_Element_licensePlate"><span style="color:red">*</span>LicensePlate</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="licensePlate" placeholder="LicensePlate" id="modal_Update_Form_Element_licensePlate">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="modal_Update_Form_Element_locationDeviceId"><span style="color:red">*</span>Location DeviceId</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="locationDeviceId" placeholder="Location DeviceId" id="modal_Update_Form_Element_locationDeviceId">
                                        </div>
                                    </div>
